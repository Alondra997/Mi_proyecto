    <?php
            ...
            $consulta = "UPDATE personales SET nom_per='$nom_per', ape_per='$ape_per', gen_per='$gen_per', curp_per='$curp_per', dir_per='$dir_per',
            ciu_per='$ciu_per', ser_per='$ser_per', est_per='$est_per', hij_per='$hij_per', img_per='$img_per' WHERE id_per='$id_per'";
